                  ...
                  child: Card(
                    ...
                    child: CustomTextField(
                      ...
                      onChange: (value) {
                        ...
                        if (gridController.checkList.contains(
                            value.toLowerCase())) {
                          ...
                          if (gridFormKey.currentState!.validate()) {
                            ...
                            for (int i = 0; i < row; i++) {
                              ...
                              for (int j = 0; j < column; j++) {
                                gridController.characterList[i].add(gridController.alphabetInputController.text[count]); // Calculate index to access elements from listText
                                gridController.checkList.add(gridController.characterList[i][j].trim().toLowerCase());
                                count++;
                              }
                            }
                                ...
                                child: GridTile(
                                  child: AnimatedContainer(
                                    decoration: BoxDecoration(
                                      color: gridController.matchAlphabet
                                          .value == 1 && gridController
                                          .checkList[index]
                                          .toLowerCase() == gridController
                                          .searchCharacterController.text
                                          .toLowerCase()
                                          ? Colors.orangeAccent
                                          : Colors.blue,
                                    ),
